 ...
 */
public class MVLRGraphNodePlugin extends Plugin {
    // The shared instance.
    private static MVLRGraphNodePlugin plugin;

    /**
     * The constructor.
     */
    public MVLRGraphNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static MVLRGraphNodePlugin getDefault() {
        return plugin;
    }
